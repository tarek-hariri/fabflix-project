...
public class UpdateSecurePassword {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            alterResult = employeeStatement.executeUpdate(alterQuery);
            ...
            ResultSet employeeRS = employeeStatement.executeQuery(query);
            ...
            for (String updateQuery : employeeUpdateQueryList) {
                int updateResult = employeeStatement.executeUpdate(updateQuery);
                count += updateResult;
            }
            System.out.println("updating password completed, " + count + " rows affected");
